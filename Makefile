...
SRC_FILES		+= src/HttpServer/Structs/Response_Constructors.cpp
SRC_FILES		+= src/HttpServer/Structs/Response_ToString.cpp
SRC_FILES		+= src/HttpServer/Structs/Response_Factory1.cpp
SRC_FILES		+= src/HttpServer/Structs/Response_Factory2.cpp
SRC_FILES		+= src/HttpServer/Structs/Response_Factory3.cpp
SRC_FILES		+= src/HttpServer/Structs/Response_FactoryOverloads.cpp
SRC_FILES		+= src/HttpServer/Structs/Response_StatusInit.cpp
